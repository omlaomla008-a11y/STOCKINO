...
-- Le problème : le trigger essaie d'accéder à NEW.updated_at mais NEW fait référence à sales_items qui n'a pas ce champ
...
-- Recréer la fonction pour calculer le total (sans retourner NEW/OLD qui cause problème)
